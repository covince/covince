...
const Checkbox = ({ id, name, children, label = children, checked, onChange, className, style, disabled }) => (
  <div className={classNames('flex items-center', className)} style={style}>
    <div className="flex items-center justify-center h-5 relative">
      <input
        ...
        disabled={disabled}
        type="checkbox"
        className="covince-checkbox checked:bg-none outline-none focus:ring-2 focus:ring-current dark:focus:ring-offset-gray-700 ring-offset-2 h-4 w-4 text-current border-gray-300 rounded disabled:bg-gray-200"
      />
