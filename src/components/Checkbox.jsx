  ...
  <div className={classNames('flex items-center', className)} style={style}>
    <div className="flex items-center justify-center h-5 relative">
      <input
        ...
        onChange={onChange}
        type="checkbox"
        className="bg-none outline-none focus:ring-2 focus:ring-current dark:focus:ring-offset-gray-700 ring-offset-2 h-4 w-4 text-current border-gray-300 rounded"
      />
